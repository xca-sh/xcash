...
.PHONY: help init-env up down upgrade dev-sync dev-up dev-up-pro dev-up-deps dev-up-chain dev-up-signer dev-down dev-logs dev-chain-logs dev-ps dev-web dev-worker dev-worker-stress dev-worker-scan dev-beat dev-manage dev-mm dev-migrate dev-clear-migrations dev-shell dev-test dev-local-init dev-signer-migrate dev-signer-check dev-signer-e2e dev-bootstrap
...
help:
	...
	@echo "  make dev-up-chain     启动 django-db/redis/signer-db/signer/anvil"
